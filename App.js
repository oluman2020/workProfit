      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        {/* {spinnerProfileImage ?
          <View style={{height: 150, backgroundColor: '#000'}}>
            <Image
              resizeMode='cover'
              style={{ height: 150, width: '100%', opacity: 0.6, backgroundColor: '#fff'}}
              source={this.state.bannerImageUrl != '' ? {uri: `${this.state.bannerImageUrl}`} : require('./src/Images/placeHolder.jpg')}
            />
            <View style={{position: 'absolute', bottom: 20, left: 20}}>
              <SkeletonPlaceholder>
                <View style={{flexDirection: 'row', alignItems: 'center', }}>
                  ...
                  <View style={{height: 15, width: 90, borderRadius: 5, marginBottom: 5}}/>
        ...
        <View style={{ backgroundColor: '#000' }}>
          <View style={{ height: 150, backgroundColor: '#000', position: 'relative' }}>
            <Image
              resizeMode='cover'
              style={{ height: 150, width: '100%', opacity: 0.6, backgroundColor: '#fff' }}
              source={this.state.bannerImageUrl != '' ? { uri: `${this.state.bannerImageUrl}` } : require('./src/Images/placeHolder.jpg')}
          ...
          <View style={{ position: 'absolute', flexDirection: 'row', alignItems: 'center', bottom: 20, left: 20 }}>
            {storedValue != '' ? (
              <Image
            ...
            <View
              style={{ marginLeft: 10 }}>
              {storedValue != '' ? (
                <Text style={{ fontWeight: '700', color: '#fff', fontSize: 16, marginBottom: 3 }}>{storedValue}</Text>
              ) : (
                <Text style={{ fontWeight: '700', color: '#fff', fontSize: 16, marginBottom: 3 }}>{CONSTANT.DrawerGuest}</Text>
              )}
              {storedType != '' ? (
                <Text style={{ fontWeight: '700', color: '#fff', fontSize: 14 }}>{storedType}</Text>
              ) : (
                <Text style={{ fontWeight: '700', color: '#fff', fontSize: 14 }}>{CONSTANT.DrawerGreeting}</Text>
              )}
            </View>
          </View>
        </View>
                  ...
                  <View
                    ...
                    <SkeletonPlaceholder>
                      <View style={{ flexDirection: 'row', alignItems: 'center', }}>
                        ...
                        <View style={{ marginLeft: 10, flexDirection: 'column' }}>
                          <View style={{ height: 10, width: 70, borderRadius: 5, marginBottom: 5 }} />
                    ...
                    {this.state.SwitchUserInfo.type != 'not_exist' ? (
                      ...
                      >
                        <View
                          ...
                          <MaterialCommunityIcons name="account-switch-outline" size={24} color={'#9b59b6'} />
                        </View>
                      </TouchableOpacity>
                    ) :
                      <TouchableOpacity
